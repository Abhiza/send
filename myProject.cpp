...
int clsobjdet, clsobjdet2, adjspeed;
int ISA;
int GT = 0;
int lidardistance;
...
void i2c_setBuffer(string data) // kolom buffer I2C
{
    ...
    else if(data.compare("set")==0) // di bawah adalah code I2C untuk kecepatan dan belokan
    {
        ...
        uint8_t brake1 = abs(steering); //bilangan absolute, sama seperi cara konsep diatas
        uint8_t brake2 = (uint8_t)((((float)steering)-((float)steeringDat1))*100); // data steering tp bentuknya  float
...
//         return 700;
//     } else if (InputSpeed == 80) {
//         return 600;
//     } else if (InputSpeed == 70) {
//         return 500;
//     } else if (InputSpeed == 60) {
//         return 400;
//     } else if (InputSpeed == 50) {
//         return 250;
//     } else if (InputSpeed == 40) {
//         return 200;
//     } else if (InputSpeed == 30) {
//         return 150;
//     } else {
//         return 0; // Kecepatan Tidak Sesuai
//     }
// }
...
void speed2() {
    if (InputSpeed == 100) {
        ...
        kecepatan = 0; // Kecepatan Tidak Sesuai
    }
}
void teleoperasi() {
    if (inputtele == 10) {
        ...
        kectele = 0; // Kecepatan Tidak Sesuai
    }
}
/*---------------------------------------------------------------------------*/
...
/* radian to degree converter *///extern "C" void* myProgram3(void* p);
...
int threshVal=100,minLineLen=10,maxLineGap=45,rhoVal=1,thetaVal=1; // ini default tidak usah diatur, bisa diatur di UI saat program jalan, sampai 458
//int ISA=0;
...
extern "C" void* myProgram(void* p) // thread program 1, isinya  mengirim i2c
{
    ...
    for(;;)
    {
        if(get_millis()-ms>=500) // refresh rate kirim I2C
        {
            ...
            //         speed = kec;
            //         std::cout << "ON                           " << std::endl;
            //     } else if (clsobjdet == 2 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 1.65f;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 2 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 2 && GT == 1 && ISA == 0 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 1.65f;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 2 && GT == 1 && ISA == 0 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 2.2f;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 1 && 0 < adjspeed < 200 && lidardistance >= InputDistance) {
            //         speed = 2.2f;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 1 && 0 < adjspeed < 200 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 0 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 0 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 1 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 0 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 1 && GT == 0 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 2.78f;
            //         std::cout << "kecepatan = 10 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         //std::cout << "kecepatan = 10 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 1 && 0 < adjspeed < 200 && lidardistance >= InputDistance) {
            //         speed = 2.78f;
            //         std::cout << "kecepatan = 10 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 1 && 0 < adjspeed < 200 && lidardistance < InputDistance) {
            //         speed = kec;
            //     } else if (clsobjdet == 3 && GT == 0 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 0 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 1 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 0 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 3 && GT == 0 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 1.65f;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 61 && lidardistance >= InputDistance) {
            //         speed = 1.7f;
            //         std::cout << "kecepatan = 6.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 61 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 62 && lidardistance >= InputDistance) {
            //         speed = 1.725f;
            //         std::cout << "kecepatan = 6.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 62 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 63 && lidardistance >= InputDistance) {
            //         speed = 1.75f;
            //         std::cout << "kecepatan = 6.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 63 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 64 && lidardistance >= InputDistance) {
            //         speed = 1.775f;
            //         std::cout << "kecepatan = 6.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 64 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 65 && lidardistance >= InputDistance) {
            //         speed = 1.8f;
            //         std::cout << "kecepatan = 6.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 65 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 66 && lidardistance >= InputDistance) {
            //         speed = 1.825f;
            //         std::cout << "kecepatan = 6.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 66 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 67 && lidardistance >= InputDistance) {
            //         speed = 1.85f;
            //         std::cout << "kecepatan = 6.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 67 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 68 && lidardistance >= InputDistance) {
            //         speed = 1.875f;
            //         std::cout << "kecepatan = 6.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 68 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 69 && lidardistance >= InputDistance) {
            //         speed = 1.9f;
            //         std::cout << "kecepatan = 6.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 69 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 70 && lidardistance >= InputDistance) {
            //         speed = 1.925f;
            //         std::cout << "kecepatan = 7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 70 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 71 && lidardistance >= InputDistance) {
            //         speed = 1.95f;
            //         std::cout << "kecepatan = 7.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 71 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 72 && lidardistance >= InputDistance) {
            //         speed = 1.975f;
            //         std::cout << "kecepatan = 7.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 72 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 73 && lidardistance >= InputDistance) {
            //         speed = 2.0f;
            //         std::cout << "kecepatan = 7.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 73 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 74 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 74 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 75 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 75 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 76 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.6 km/jam" << std::endl;
            //         } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 76 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 77 && lidardistance >= InputDistance) {
            //         speed = 2.125f;
            //         std::cout << "kecepatan = 7.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 77 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 78 && lidardistance >= InputDistance) {
            //         speed = 2.15f;
            //         std::cout << "kecepatan = 7.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 78 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 79 && lidardistance >= InputDistance) {
            //         speed = 2.175f;
            //         std::cout << "kecepatan = 7.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 79 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 80 && lidardistance >= InputDistance) {
            //         speed = 2.2f;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 80 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 81 && lidardistance >= InputDistance) {
            //         speed = 2.225f;
            //         std::cout << "kecepatan = 8.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 81 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 82 && lidardistance >= InputDistance) {
            //         speed = 2.25f;
            //         std::cout << "kecepatan = 8.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 82 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 83 && lidardistance >= InputDistance) {
            //         speed = 2.275f;
            //         std::cout << "kecepatan = 8.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 83 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 84 && lidardistance >= InputDistance) {
            //         speed = 2.3f;
            //         std::cout << "kecepatan = 8.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 84 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 85 && lidardistance >= InputDistance) {
            //         speed = 2.35f;
            //         std::cout << "kecepatan = 8.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 85 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 86 && lidardistance >= InputDistance) {
            //         speed = 2.375f;
            //         std::cout << "kecepatan = 8.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 86 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 87 && lidardistance >= InputDistance) {
            //         speed = 2.4f;
            //         std::cout << "kecepatan = 8.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 87 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 88 && lidardistance >= InputDistance) {
            //         speed = 2.425f;
            //         std::cout << "kecepatan = 8.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 88 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 89 && lidardistance >= InputDistance) {
            //         speed = 2.45f;
            //         std::cout << "kecepatan = 8.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 89 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 90 && lidardistance >= InputDistance) {
            //         speed = 2.5f;
            //         std::cout << "kecepatan = 9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 90 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 91 && lidardistance >= InputDistance) {
            //         speed = 2.525f;
            //         std::cout << "kecepatan = 9.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 91 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 92 && lidardistance >= InputDistance) {
            //         speed = 2.55f;
            //         std::cout << "kecepatan = 9.2 km/jam" << std::endl;
            //         } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 92 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 93 && lidardistance >= InputDistance) {
            //         speed = 2.575f;
            //         std::cout << "kecepatan = 9.3 km/jam" << std::endl;
            //         } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 93 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 94 && lidardistance >= InputDistance) {
            //         speed = 2.6f;
            //         std::cout << "kecepatan = 9.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 94 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 95 && lidardistance >= InputDistance) {
            //         speed = 2.625f;
            //         std::cout << "kecepatan = 9.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 95 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 96 && lidardistance >= InputDistance) {
            //         speed = 2.65f;
            //         std::cout << "kecepatan = 9.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 96 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 97 && lidardistance >= InputDistance) {
            //         speed = 2.675f;
            //         std::cout << "kecepatan = 9.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 97 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 98 && lidardistance >= InputDistance) {
            //         speed = 2.7f;
            //         std::cout << "kecepatan = 9.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 98 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 99 && lidardistance >= InputDistance) {
            //         speed = 2.74f;
            //         std::cout << "kecepatan = 9.9 km/jam" << std::endl;
            //       } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed == 99 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 9.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed >= 100 && lidardistance >= InputDistance) {
            //         speed = 2.78f;
            //         std::cout << "kecepatan = 10 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 1 && adjspeed >= 100 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 10 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 1 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 0 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 4 && GT == 0 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance >= InputDistance) {
            //         speed = 1.65f;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed <= 60 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 61 && lidardistance >= InputDistance) {
            //         speed = 1.7f;
            //         std::cout << "kecepatan = 6.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 61 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 62 && lidardistance >= InputDistance) {
            //         speed = 1.725f;
            //         std::cout << "kecepatan = 6.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 62 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 63 && lidardistance >= InputDistance) {
            //         speed = 1.75f;
            //         std::cout << "kecepatan = 6.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 63 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 64 && lidardistance >= InputDistance) {
            //         speed = 1.775f;
            //         std::cout << "kecepatan = 6.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 64 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 65 && lidardistance >= InputDistance) {
            //         speed = 1.8f;
            //         std::cout << "kecepatan = 6.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 65 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 66 && lidardistance >= InputDistance) {
            //         speed = 1.825f;
            //         std::cout << "kecepatan = 6.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 66 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 67 && lidardistance >= InputDistance) {
            //         speed = 1.85f;
            //         std::cout << "kecepatan = 6.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 67 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 68 && lidardistance >= InputDistance) {
            //         speed = 1.875f;
            //         std::cout << "kecepatan = 6.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 68 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 69 && lidardistance >= InputDistance) {
            //         speed = 1.9f;
            //         std::cout << "kecepatan = 6.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 69 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 70 && lidardistance >= InputDistance) {
            //         speed = 1.925f;
            //         std::cout << "kecepatan = 7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 70 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 71 && lidardistance >= InputDistance) {
            //         speed = 1.95f;
            //         std::cout << "kecepatan = 7.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 71 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.1 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 72 && lidardistance >= InputDistance) {
            //         speed = 1.975f;
            //         std::cout << "kecepatan = 7.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 72 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.2 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 73 && lidardistance >= InputDistance) {
            //         speed = 2.0f;
            //         std::cout << "kecepatan = 7.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 73 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.3 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 74 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 74 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.4 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 75 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 75 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.5 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 76 && lidardistance >= InputDistance) {
            //         speed = 2.02f;
            //         std::cout << "kecepatan = 7.6 km/jam" << std::endl;
            //         } else if (clsobjdet== 5 && GT == 1 && ISA == 1 && adjspeed == 76 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.6 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 77 && lidardistance >= InputDistance) {
            //         speed = 2.125f;
            //         std::cout << "kecepatan = 7.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 77 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.7 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 78 && lidardistance >= InputDistance) {
            //         speed = 2.15f;
            //         std::cout << "kecepatan = 7.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 78 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 79 && lidardistance >= InputDistance) {
            //         speed = 2.175f;
            //         std::cout << "kecepatan = 7.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 79 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 7.9 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 80 && lidardistance >= InputDistance) {
            //         speed = 2.2f;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 1 && adjspeed == 80 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 8 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 1 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 0 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 5 && GT == 0 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 1 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = 1.65f;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 1 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 6 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 0 && ISA == 1 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 0 && ISA == 1 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 1 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 1 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 0 && ISA == 0 && lidardistance >= InputDistance) {
            //         speed = kec;
            //         std::cout << "kecepatan = 0 km/jam" << std::endl;
            //     } else if (clsobjdet == 6 && GT == 0 && ISA == 0 && lidardistance < InputDistance) {
            //         speed = kec;
            ...
            //     }
                ...
                cout <<"                             KecepatanReal = "<< speed_kmph << endl;
                cout <<"GT = "<< GT << endl;
                cout <<"ISA = "<< ISA << endl;
                //printf(GT);
                i2c_setBuffer("set");
        ...
        if(get_millis()-ms4>=100) // refresh rate untuk kalkulasi line keeping purePursuit
        {
            ...
            cout << "steering angle tele = "<<steeringtele << endl;
            cout << "speed = "<<speed << endl;
            cout << "speed = "<<inputtele << endl;
...
extern "C" void* myProgram2(void* p) 
{
    ...
    while (1) {
        ...
        if (bytes_read < 0) {
            ...
            int num_items = sscanf(reinterpret_cast<const char*>(data_buffer), "%d,%d,%d,%d,%d,%d,%d, %fn", &clsobjdet, &adjspeed, &lidardistance, &rpmMotorTacho, &InputSpeed, &InputDistance, &ISA, &kec);
            if (num_items == 8) {
            ...
            // if (num_items == 4) {
                ...
                printf("Received data: class = %d, adjspeed = %d, distance = %d, rpmMotorTacho = %d, InputSpeed = %d, InputDistance = %d, ISA = %d, kec = %f\n", clsobjdet, adjspeed, lidardistance, rpmMotorTacho, InputSpeed, InputDistance, ISA, kec);
                outputRPM = rpmMotorTacho / gearRatio;
                speed_kmph = (outputRPM * wheelCircumference * 60.0) / 1000.0;
                // if (10 < clsobjdet < 99){
                //     clsobjdet2 = clsobjdet / 10;
                // } else if (100 < clsobjdet < 999){
                //     clsobjdet2 = clsobjdet / 100;
                // } else if (1000 < clsobjdet < 9999){
                //     clsobjdet2 = clsobjdet / 1000;
                // } else if (10000 < clsobjdet < 99999){
                //     clsobjdet2 = clsobjdet / 10000;
                // } else if (100000 < clsobjdet < 999999){
                //     clsobjdet2 = clsobjdet / 100000;
                // } else if (1000000 < clsobjdet < 9999999){
                //     clsobjdet2 = clsobjdet / 1000000;
                // }
            } else {
                // Invalid data format
...
{	
    ...
    try
    {
        ...
        csvfile csv("k50variasi.csv");
        csv << "ms" << "speed" << "steering" << "clsobjdet" << "GT" << "ISA" << "adjspeed" << "lidardistance" << "rpmMotorTacho" << "speed_kmph" << "InputSpeed" << "InputDistance" << endrow;
        //csv << "ms" << "speed" << "steering" << "clsobjdet" << "GT" << "ISA" << "adjspeed" << "lidardistance" << "rpmMotorTacho" << endrow;
        ms3=get_millis();
        float c=0.f;
        char myBuffer[8];
        while(true)
        {
            if(get_millis()-ms3>=100)
            {
                ...
                csv << myBuffer << speed << steering << clsobjdet << GT << ISA << adjspeed << lidardistance << rpmMotorTacho << speed_kmph << InputSpeed << InputDistance << endrow;
            }
        }
    }
    catch(const std::exception& e)
